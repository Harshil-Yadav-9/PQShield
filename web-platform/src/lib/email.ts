...
export class EmailNotConfiguredError extends Error {
  constructor() {
    super(
      "GMAIL_USER / GMAIL_APP_PASSWORD are not set, so PQShield cannot send emails. See .env.example / the README's \"Email verification\" section for the 2-minute Gmail App Password setup.",
    );
